...
main (int argc, char *argv[])
{
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("tcp-example3.cwnd");
  ...
  p2p1.EnableAsciiAll (ascii.CreateFileStream ("tcp-example3.tr"));
  p2p1.EnablePcapAll ("tcp-example3");
